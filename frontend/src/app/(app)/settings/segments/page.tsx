...
function buildFilterRules(values: SegmentFormValues): Record<string, unknown> {
...
function parseFilterRules(rules: Record<string, unknown>): Partial<SegmentFormValues> {
  return {
