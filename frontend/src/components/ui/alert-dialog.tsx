...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title ref={ref} className={cn('text-h2 text-[var(--text)]', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description ref={ref} className={cn('text-body-sm text-[var(--text-muted)]', className)} {...props} />
));
...
export {
  ...
  AlertDialogDescription, AlertDialogAction, AlertDialogCancel, AlertDialogClose,
};
